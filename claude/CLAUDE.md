...
- Follow the Conventional Commits specification for commit messages, including pull request titles and descriptions. Use sentence case after the prefix (e.g., `fix: Correct minor typos in code`).
